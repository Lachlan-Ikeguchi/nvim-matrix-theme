...
2. **Update this file with your findings** - Document:
   - What you checked
...
5. **Date your entries** - Always include the date of your work.
...
5. Document the issue and fix in this file

### How to Add New Colour Categories

If you add new colour categories to the palette:

1. Add the category to the Colour Categories section
2. Define the colour variables in `lua/matrix/colors.lua`
3. Update the section headers in theme files
4. Document the new category and its purpose
5. Update the verification guidelines

---

## 📝 Update Log

| Date | Agent | Task | Changes |
|------|-------|------|---------|
| 2025-07-05 | Initial agent | Double check colours are as documented | Created this file, identified 14+ mismatches, applied fixes to theme.lua |
| 2025-07-05 | Initial agent | Commit colour fixes | Committed 14 fixes to theme.lua and created AGENTS.md living documentation |
